...
config :projetopay,
  ecto_repos: [Projetopay.Repo]

# Configures the endpoint
config :projetopay, ProjetopayWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: ProjetopayWeb.ErrorView, accepts: ~w(json), layout: false],
...
config :projetopay, Projetopay.Mailer, adapter: Swoosh.Adapters.Local
